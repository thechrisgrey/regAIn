...
# The API stack defines exactly 6 non-OPTIONS methods:
# POST /onboarding, GET /missions, POST /missions/{missionId}/complete,
# GET /evidence, POST /coaching/checkin, GET /dashboard
EXPECTED_METHOD_COUNT = 6
