...
- **Lambda reserved concurrency**: Voice Session + Chat Stream: 50 each, Voice Practice WS: 30, Resume: 10. API Lambdas (Dashboard, Missions, Evidence, etc.) use the unreserved pool
